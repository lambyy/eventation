...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506301997/seed%20photos/pexels-photo-431722_fd1vpv.jpg",
...
Ticket.create({event_id: e1.id, name: "Regular", quantity: 200, price: 5})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506446267/seed%20photos/rchynp8rbnykr8arnuzv.jpg",
...
Free admission before 11:00 PM, $10 cover charge after",
category: "Music", event_type: "Concert"})

Ticket.create({event_id: e2.id, name: "FREE Before 11:00 with RSVP", quantity: 500, price: 0})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506301999/seed%20photos/pexels-photo-461428_x5sjyy.jpg",
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506302339/seed%20photos/pexels-photo-129523_ecimym.jpg",
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506301993/seed%20photos/pexels-photo-66636_wom3s2.jpg",
...
Ticket.create({event_id: e5.id, name: "Wine Night", quantity: 25, price: 60})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506302039/seed%20photos/business-innovation-money-icon-40218_ucuzcr.jpg",
...
t3 = Ticket.create({event_id: e6.id, name: "Executive", quantity: 200, price: 250})
t4 = Ticket.create({event_id: e6.id, name: "Business", quantity: 2000, price: 100})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506301994/seed%20photos/pexels-photo-297648_j98bwn.jpg",
...
Ticket.create({event_id: e7.id, name: "Basic Course", quantity: 30, price: 75})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506301997/seed%20photos/pexels-photo-374632_o2srbi.jpg",
...
Ticket.create({event_id: e8.id, name: "First Course Only", quantity: 100, price: 0})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506301993/seed%20photos/lights-party-dancing-music_mzf7nv.jpg",
...
Tickets on sale now! Doors open at 9:00 PM. Early bird admission until 11:00 PM.",
category: "Music", event_type: "Party"})

t5 = Ticket.create({event_id: e9.id, name: "FREE Before 11:00 PM with RSVP", quantity: 500, price: 0})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506646686/seed%20photos/q2tocszezyusgsnsmsp2.jpg",
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506302039/seed%20photos/relay-race-competition-stadium-sport_ulsmjq.jpg",
...
Ticket.create({event_id: e11.id, name: "College/University", quantity: 300, price: 50})
Ticket.create({event_id: e11.id, name: "Public", quantity: 300, price: 80})
...
image_url: "https://res.cloudinary.com/drdaiyfdt/image/upload/v1506302338/seed%20photos/pexels-photo-442576_tgfytz.jpg",
...
Ticket.create({event_id: e12.id, name: "Premier", quantity: 100, price: 100})
Ticket.create({event_id: e12.id, name: "Regular", quantity: 2000, price: 40})


Registration.create({user_id: u1.id, ticket_id: t1.id, num_tickets: 2})
Registration.create({user_id: u1.id, ticket_id: t2.id, num_tickets: 2})
